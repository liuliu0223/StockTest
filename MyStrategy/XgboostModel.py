...
def xgb_train(data, rundnum, time_windows):
    ...
    train_size = int(len(data_set_process)*0.95)
    ...
    # 算法参数:sz002895(川恒），20180101， XGBoost平均误差率为：3.1654126942157745%
    params = {
        'booster': 'gbtree',
    ...
    print('XGBoostModelTest.py ----- max:%.2f, min:%.2f' % (max_pred, min_pred))
    return (pred_data)